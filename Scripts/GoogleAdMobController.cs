...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    public void RequestBannerAd()
    {
        ...
        // this is a TEST ID !  "    ca-app-pub-3940256099942544/6300978111   "

        string adUnitId = "ca-app-pub-3659041950036775/5597749609";
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        // this is a TEST ID !      "    ca-app-pub-3940256099942544/5224354917   "

        string adUnitId = "ca-app-pub-3659041950036775/3761622439";
        ...
        {
            PrintStatus("failed to load: " + args.LoadAdError.GetMessage() + " cause :" + args.LoadAdError.GetCause());
            GameObject.Find("MainController").GetComponent<WorldController>().SetNoAdsAvaiable();
            OnAdFailedToLoadEvent.Invoke();
        };
        ...
        {
            SetInspectorText("RewardedAd    " + args.Amount);
    ...
    private void SetInspectorText(String msg)
    {
        MobileAdsEventExecutor.ExecuteInUpdate(() =>
        {
            TriggerRewardFunction();
            statusText.text = msg;
        });
    }

    private void TriggerRewardFunction()
    {
        GameObject.Find("MainController").GetComponent<WorldController>().DoneRewardedAds();
    }
